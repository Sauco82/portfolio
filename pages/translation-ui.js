  ...
  return (
    <>
      ...
      <Intro images={[
        ...
        <p>Obviously the most important part of a translation company is translating, the Translation UI is the mini app that help our translators to do so.</p>
      ...
      <Layout>        
        <div>
          ...
          <Zig img="/translatinghtml.png">
            ...
            <p>Making use of clear shapes it tries to teach translators the difference between an opening, closing and self-closing tags.</p>          
            <p>It provides with several affordances like autocompletions, dragging tags with the mouse or copy/pasting content from sources that normally would create a mess on a contenteditable container.</p>
          </Zig>
          ...
          <Zag img="/highlight.png">
            ...
            <p>I designed a process to highlight parts of segments with the types of mistakes which would result in some cases on funny looking underlining rainbows.</p>
          ...
          <Zig img="/context.png">
            ...
            <p>The context sidebar is designed first to stay out of the way for the main task, translating but at the same time being always fairly visible and at hand to help the translator as much as possible.</p>
